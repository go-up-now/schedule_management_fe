...
const Sidebar: FC<SidebarProps> = ({ setExpand }) => {
  ...
  const generateIcon = (icon: string) => {
    ...
    icons_map["student"] = (
      ...
      >
        <path
          d="M12 0L2 5v5l10 5 10-5V5L12 0zM2 18v4h20v-4H2zm0 2h20v2H2v-2z"
          fill="currentColor"
        />
      </svg>
    );
    ...
    icons_map["lecturer"] = (
      ...
      >
        <path
          d="M12 2c-2.5 0-4.5 2-4.5 4.5S9.5 11 12 11s4.5-2 4.5-4.5S14.5 2 12 2zM6 14v8h3v-6h6v6h3v-8l-6-3-6 3zm3-2h6l3-1.5V10h-3V8h-3v2H9v1.5l3 1.5zm6.5 2.5c-.276 0-.5-.224-.5-.5s.224-.5.5-.5.5.224.5.5-.224.5-.5.5z"
          fill="currentColor"
        />
        <path
          d="M17 7h-1v6h1l2-1-2-1zm-7 5l-5 2v-1.5h2V11l3 1.5zM10 6v3.5h-2V6h2z"
          fill="currentColor"
        />
        <path
          d="M16 9h1l3-1.5-3-1.5h-1V9zM12 12.5h3l1.5 1.5H12v-1.5z"
          fill="currentColor"
        />
      </svg>
    );
