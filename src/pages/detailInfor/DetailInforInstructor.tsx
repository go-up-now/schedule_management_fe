...
const DetailInforInstructor = () => {
    ...
    const handleImageAPI = async () => {
        let response = await getInstructorMyInforAPI();
                        ...
                        <div className="w-full h-full lg:w-8/12 flex flex-wrap">
                            <div className="w-full lg:w-6/12 p-1">
                                <TextField
                                    ...
                                    disable={true}
                                    className={`w-full `}
                                    value={userInfo && userInfo.user ? (userInfo.user.status ? 'Đang giảng dạy' : 'Ngừng giảng dạy') : ''}
                                />
                            </div>
                            <div className="w-full lg:w-6/12 p-1">
                                <TextField
                            ...
                            <div className="w-full lg:w-6/12 p-1">
                                <TextField
                                    ...
                                    disableLabel={false}
                                    className={`w-full`}
                                    value={userInfo && userInfo.user ? userInfo.experience : ''}
                                />
                            </div>
                            <div className="w-full lg:w-6/12 p-1">
                                <TextField
                                    ...
                                    disableLabel={false}
                                    className={`w-full `}
                                    value={userInfo && userInfo.user ? userInfo.specialization.name : ''}
                                />
                            </div>
                            <div className="w-full lg:w-6/12 p-1">
                                <TextField
                                    ...
                                    disableLabel={false}
                                    className={`w-full `}
                                    value={userInfo && userInfo.user ? userInfo.year : ''}
                                />
                            </div>
                            <div className="w-full lg:w-6/12 p-1">
                                <TextField
...
export default DetailInforInstructor;